//A Simple Tic Tac Toe game by Jason Lester.My first game written in c++!!
#include<iostream>
#include <string>
using namespace std;
...
int main(){
cout<<"Hello! Welcome. to play when you are prompted, enter the number of the square you want to play in. Have Fun!"<<endl;
grid();
